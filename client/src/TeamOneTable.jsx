...
const TeamOneTable = ({ players }) => {
  ...
  //line 66 prevents app from rendering until this component has received the necessary data (players)
  if (players.length) {
    return (
      <StyledDiv>
        ...
        <div style={{width: "40%", display: "table", marginBottom: "10%", float: "left"}}>
          {/* line 78 maps over 'players' and renders a line of data per player in the array of objects */}
